            ...
            <section class="mt-30">
                <div class="d-block d-md-flex justify-content-between align-items-center pb-20">
                    ...
                    <div class="d-flex align-items-center mt-20 mt-md-0">
                        ...
                        <button id="add_dragdrop_question" data-quiz-id="<?php echo e($quiz->id); ?>" type="button" class="quiz-form-btn btn btn-primary btn-sm ml-10"><?php echo e(trans('quiz.add_dragdrop')); ?></button>
...
<?php if(!empty($quiz)): ?>
    ...
    <?php echo $__env->make(getTemplate() .'.panel.quizzes.modals.dragdrop_question',['quiz' => $quiz], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php endif; ?>
<?php /**PATH C:\Users\abdel\Downloads\archiveXgOhQ\resources\views/web/default/panel/quizzes/create_quiz_form.blade.php ENDPATH**/ ?>