            ...
            <section class="mt-30">
                <div class="d-block d-md-flex justify-content-between align-items-center pb-20">
                    ...
                    <div class="d-flex align-items-center mt-20 mt-md-0">
                        ...
                        <button id="add_dragdrop_question" data-quiz-id="{{ $quiz->id }}" type="button" class="quiz-form-btn btn btn-primary btn-sm ml-10">{{ trans('quiz.add_dragdrop') }}</button>
...
@if(!empty($quiz))
    ...
    @include(getTemplate() .'.panel.quizzes.modals.dragdrop_question',['quiz' => $quiz])
